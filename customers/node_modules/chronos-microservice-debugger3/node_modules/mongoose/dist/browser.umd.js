...
/*!
 * Module dependencies.
 */var n=r(52),i=r(12),o=r(18).EventEmitter,s=r(144),a=r(7),u=r(27),c=r(80),l=r(5),f=r(81),h=r(3),p=r(1),d=r(82),y=r(0).arrayParentSymbol,_=r(0).arrayPathSymbol,v=void 0,m=void 0;function g(t,e,r,i){null!=i&&null!=i._id?e=f(e,i):null!=r&&null!=r._id&&(e=f(e,r));var o=b(e,r);o.prototype.$basePath=t,n.call(this,t,o,r),this.schema=e,this.schemaOptions=i||{},this.$isMongooseDocumentArray=!0,this.Constructor=o,o.base=e.base;var s=this.defaultValue;"defaultValue"in this&&void 0===s||this.default(function(){var t=s.call(this);return Array.isArray(t)||(t=[t]),t});var u=this;this.$embeddedSchemaType=new a(t+".$",{required:l(this,"schemaOptions.required",!1)}),this.$embeddedSchemaType.cast=function(t,e,r){return u.cast(t,e,r)[0]},this.$embeddedSchemaType.$isMongooseDocumentArrayElement=!0,this.$embeddedSchemaType.caster=this.Constructor,this.$embeddedSchemaType.schema=this.schema}
/*!
 * Ignore
 */
 ...
 * ignore
 */
g.prototype.getDefault=function(t){var e="function"==typeof this.defaultValue?this.defaultValue.call(t):this.defaultValue;if(null==e)return e;v||(v=r(16)),Array.isArray(e)||(e=[e]);var n=(e=new v(e,this.path,t))[y];e[y]=null;for(var i=0;i<e.length;++i){var o=d(this.casterConstructor,e[i]);e[i]=new o(e[i],e,void 0,void 0,i)}return e[y]=n,e},g.prototype.cast=function(t,e,n,o,s){v||(v=r(16));var a=void 0,u=void 0,c=void 0,l={transform:!1,virtuals:!1};if(!Array.isArray(t)){if(!n&&!g.options.castNonArrays)throw new i("DocumentArray",h.inspect(t),this.path,null,this);return e&&n&&e.markModified(this.path),this.cast([t],e,n,o)}for(t&&t.isMongooseDocumentArray||s&&s.skipDocumentArrayCast?t&&t.isMongooseDocumentArray&&(t=new v(t,this.path,e)):t=new v(t,this.path,e),c=t.length;c--;)if(t[c]){var f=d(this.casterConstructor,t[c]);if(!t[c].$__||t[c]instanceof f||(t[c]=t[c].toObject({transform:!1,virtuals:t[c].schema===f.schema})),t[c]instanceof m)null==t[c].__index&&t[c].$setIndex(c);else if(null!=t[c])if(n)e?a||(a=w(this,e.$__.selected,n)):a=!0,u=new f(null,t,!0,a,c),t[c]=u.init(t[c]);else if(o&&"function"==typeof o.id&&(u=o.id(t[c]._id)),o&&u&&p.deepEqual(u.toObject(l),t[c]))u.set(t[c]),t[c]=u;else try{u=new f(t[c],t,void 0,void 0,c),t[c]=u}catch(e){var y=h.inspect(t[c]);throw new i("embedded",y,t[_],e,this)}}return t},
/*!
 * ignore
 */
