    ...
    <div className="about">
      <div className="blurb">
        ...
        <p style={currentMode} className="text">
          The Chronos Team has always had passion for Open Source endeavors that would greatly
          benefit benefit the developer community. With many existing paid options being difficult
        ...
        <p style={currentMode} className="text">
          ...
          Brian, Alon, Alan, Ousman, Ben, Chris, Jenae, Tim, Kirk, Jessica, William, Alexander
        </p>
        <br />
