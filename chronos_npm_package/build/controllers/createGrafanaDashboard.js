...
// Import the default export from GrafanaPanel.ts as an object.
const GrafanaPanel_1 = require("../controllers/GrafanaPanel");
async function createGrafanaDashboard(metrix, datasource) {
    // Create the dashboard payload
    const dashboard = {
        dashboard: {
            id: null,
    ...
    const panel = (0, GrafanaPanel_1.createGrafanaPanelObject)(metrix, datasource);
    dashboard.dashboard.panels.push(panel);
    try {
        // POST request to Grafana Dashboard API to create/update a dashboard
...
//# sourceMappingURL=createGrafanaDashboard.js.map