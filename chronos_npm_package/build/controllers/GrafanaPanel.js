...
exports.createGrafanaPanelObject = createGrafanaPanelObject;
exports.updateGrafanaPanelObject = updateGrafanaPanelObject;
//         },
//         "id": 1,
//         "targets": [{
//             "datasource": datasource,
 ...
 */
function createGrafanaPanelObject(metric, datasource, graphType) {
    // For example, you might use a default graph type if none is provided:
    const resolvedGraphType = graphType || 'defaultGraphType';
    return {
        datasource,
 ...
 */
function updateGrafanaPanelObject(metric, datasource, graphType) {
...
//# sourceMappingURL=GrafanaPanel.js.map