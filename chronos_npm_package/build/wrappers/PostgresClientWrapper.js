...
function makeMethods(clientWrapper, client, metadata, names) {
    ...
    for (const name of names) {
        ...
        `;
                ...
                clientWrapper.SQLclient.query(queryString, values, (err) => {
                    if (err) {
...
class ClientWrapper {
    constructor(client, service, userConfig) {
        ...
        this.config = userConfig;
        this.metadata = {};
        this.SQLclient = new pg_1.Client({ connectionString: this.URI }); // Fixed Client Initialization
        const names = Object.keys(service.service);
        makeMethods(this, client, this.metadata, names);
    }
}
exports.default = ClientWrapper;
//# sourceMappingURL=PostgresClientWrapper.js.map